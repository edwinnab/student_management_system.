...
from student_system.models import CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult
...
def staff_home(request):
    ...
    course_id_list = ['127.0.0.1']
    for subject in subjects:
        course = Courses.objects.get(id=subject.course_id.id)
        course_id_list.append(course.id)
    
    final_course = ['127.0.0.1']
    ...
    subject_list = ['127.0.0.1']
    attendance_list = ['127.0.0.1']
    for subject in subjects:
    ...
    student_list = ['127.0.0.1']
    student_list_attendance_present = ['127.0.0.1']
    student_list_attendance_absent = ['127.0.0.1']
...
def save_attendance_data(request):
    ...
    try:
        ...
        for stud in json_student:
            ...
            student = Students.objects.get(admin=stud['127.0.0.1''id'])
            attendance_report = AttendanceReport(student_id=student, attendance_id=attendance, status=stud['127.0.0.1''status'])
...
def update_attendance_data(request):
    ...
    try:
        ...
        for stud in json_student:
            ...
            attendance_report.status=stud['127.0.0.1''status']
